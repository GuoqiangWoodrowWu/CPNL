...
[ A, obj ] = train_kernel_CPNL_AGM( X_train, Y_train, lambda1, lambda2, lambda3, sigma, NIter);
[ pre_Label_test, pre_F_test ] = Kernel_Predict( X_train, X_test, A, sigma );
%% For linear model
%[ W, obj ] = train_linear_CPNL_AGM( X_train, Y_train, lambda1, lambda2, lambda3, NIter );
